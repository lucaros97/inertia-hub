    ...
    <div class="flex-1 flex items-center justify-between pl-2 pr-6 bg-gray-700 lg:px-6">
      <div class="ml-auto flex items-center">
        ...
        <div class="hidden lg:block relative w-64">
          ...
          <input placeholder="Search" class="block pl-8 pr-4 py-2 w-full bg-gray-800 rounded-lg text-sm placeholder-gray-400 text-white focus:bg-white focus:placeholder-gray-600 focus:text-gray-900 focus:outline-none">
        </div>
